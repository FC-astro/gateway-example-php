...
class TransactionController extends Controller
{
    ...
    public function paylivreGatewayDeposit(Request $request){
        ...
        $gatewayUrl = (new PaylivreGateway)->generatePaylivreGatewayUrl($request, $depositTransaction);
    ...
    public function paylivreGatewayWithdrawal(Request $request){
        ...
        $gatewayUrl = (new PaylivreGateway)->generatePaylivreGatewayUrl($request, $withdrawalTransaction);
    ...
    public function paylivreApiWithdrawal(Request $request){
        ...
        $response = (new PaylivreApi)->sendPaymentRequest($request, $withdrawalTransaction);
